...
class NonMembersNotAllowed extends Component {

  render() {
    const { bubbleName } = this.props;
    return (
      <div style={CommonStyles.common.boxStyle}>
        ...
        <div style={CommonStyles.common.textStyle}>
          You can't see information of this bubble.<br/> Please join <span style={{ color: '#5ed28f' }}>{bubbleName}</span>.
        </div>
      </div>
    );
  }
...
export default NonMembersNotAllowed;
